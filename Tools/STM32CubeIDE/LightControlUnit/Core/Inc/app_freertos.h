...
/* USER CODE END EM */
extern osThreadId_t Task_Bsw_1msHandle;
extern osThreadId_t Task_App_1msHandle;
extern osThreadId_t Task_Bsw_10msHandle;
extern osThreadId_t Task_App_10msHandle;
